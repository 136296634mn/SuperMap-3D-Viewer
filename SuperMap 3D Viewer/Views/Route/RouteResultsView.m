...
@interface RouteResultsView () <UITableViewDataSource, UITableViewDelegate>
...
@implementation RouteResultsView
...
- (void)handleSearchMenuButtonEvent:(UIButton *)sender {
    ...
    if ([currentImage isEqual:self.shrinkImage]) {
        ...
        [Animation applyShrinkAnimationToRouteMenu:self.superview];
        ...
        [Animation applyExtendAnimationToRouteMenu:self.superview];
    }
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [Bridge sharedInstance].selectRouteResultsCellEvent(model.name);
}
